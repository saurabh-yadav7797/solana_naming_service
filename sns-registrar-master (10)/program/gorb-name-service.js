...
async function main() {
    ...
    // 1. Create accounts (wallet addresses)
    console.log('👤 Creating accounts...');
    const anuragKeypair = Keypair.generate();
    const rachitKeypair = Keypair.generate();
    
    console.log(`   Anurag Account: ${anuragKeypair.publicKey.toString()}`);
    console.log(`   Rachit Account: ${rachitKeypair.publicKey.toString()}\n`);
    
    // 2. Set usernames that map to wallet addresses
    ...
    console.log(`   ✅ Anurag.gorb -> ${anurag.address}`);
    ...
    console.log(`   ✅ Rachit.gorb -> ${rachit.address}\n`);
    ...
    // 5. Transfer tokens using usernames instead of wallet addresses
    console.log('\n💸 Transferring tokens using usernames...');
    console.log('   From: Anurag.gorb (username)');
    console.log('   To: Rachit.gorb (username)');
